...
function PaginaFilmes(){
    ...
    return(
        ...
        <div className="container mx-auto my-8 p-4">
            <img src="../../img/setinha.png" className="w-8 " alt="" />
          </div>
        <main className="container mx-auto my-8 p-4">
            <h1 className="text-3xl font-bold text-red-800 mb-4">Detalhes do Filme</h1>
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    <img className="w-full h-64 object-cover" src={`https://image.tmdb.org/t/p/w1280/${filme.backdrop_path}`} alt={filme.title} />
                    <div className="p-4">
                        ...
                        <h3 className=" text-lg font-semibold underline-offset-4 underline decoration-primary-gabys">Avaliação:</h3>
                            <div className="flex items-center ml-2">
                                <svg className="w-5 h-7 text-primary-gabys" fill="currentColor" viewBox="0 0 20 20">
